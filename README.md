...
- **HTML5:** Estrutura semântica e Metatags SEO.
- **CSS3:** Estilização moderna e layout responsivo.
- **JavaScript (Vanilla):** Lógica de manipulação do DOM e cálculos de consumo.
- **SVG:** Gráficos vetoriais para a interface da garrafa.

## 💻 Como usar

1. Insira sua meta diária no campo "META".
2. Digite a quantidade de água ingerida no campo "ÁGUA INGERIDA".
3. Clique em **BEBER** para ver a garrafa encher e o contador atualizar.
4. Use o botão **ESVAZIAR GARRAFA** para resetar o seu progresso.
